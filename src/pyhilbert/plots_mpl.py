...
def plot_structure_mpl(obj: Lattice, 
    ...
    **kwargs
    ...
    if spin_data is not None:
        ...
        if is_3d:
            ...
            ax.quiver(x, y, z, u, v, w, length=0.5, normalize=True, color='red', label='Spins')
        else:
            # Quiver in 2D
...
def plot_heatmap_mpl(obj: Union[np.ndarray, torch.Tensor, object], 
...
def plot_spectrum_mpl(obj: Union[np.ndarray, torch.Tensor, object], 
...
def plot_bandstructure_mpl(obj: Union[np.ndarray, torch.Tensor, object],
